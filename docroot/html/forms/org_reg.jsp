...
<div id="main">
<form id="myform">	
	<div class="box" style="margin-left: 108px">Organization Name<b style="color: red;">*</b>:&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;<input name="org_name" id="name" class="form-control field-required" type="text" style=" border-radius: 0px 10px 0px 10px; width: 250px"></div><!-- end of box -->

	<div class="box" style="margin-left: 108px">Area of Business<b style="color: red;">*</b>: &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;<select id="" name="areabuss" class="form-control field-required"  style=" border-radius: 0px 10px 0px 10px; width: 150px">
    	<option value="1">BioTech</option>
   		<option value="2">Mechanical</option>
    	<option value="3">IT</option>
    	<option value="4">E-commerce</option></select>
    </div><!-- end of box -->
		
	<div class="box" style="margin-left: 108px">Contact No<b style="color: red;">*</b>:&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;<input name="phno" id="phno" class="form-control field-required field-digits" type="number" maxlength="10" style="border-radius: 0px 10px 0px 10px; width: 250px"></div><!-- end of box -->
	
	<div class="box" style="margin-left: 108px">E-mail<b style="color: red;">*</b>:&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;  &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;<input name="email" id="email" class="form-control field-required field-email" type="email" style="border-radius: 0px 10px 0px 10px; width: 250px"></div><!-- end of box -->
	
	<div class="box" style="margin-left: 108px">Address:<b style="color: red;">*</b>:&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;<textarea id="myTextarea" class="form-control" cols="300" rows="3" style=" height: 50px; border-radius: 0px 10px 0px 10px; width: 250px"></textarea></div><!-- end of box -->
	
	<div class="box" style="margin-left: 108px; margin-bottom: 20px">   
        <br/>Select Country:
        <select id="country" name="country" style=" border-radius: 0px 10px 0px 10px; width: 100px"></select>
        &nbsp;&nbsp;Select State:
        <select name="state" id="state" style=" border-radius: 0px 10px 0px 10px; width:130px"></select>
    ...
    <div class="box" style="margin-left: 108px;  margin-bottom: 20px">No of Users<b style="color: red;">*</b>: &nbsp;&nbsp;<input name="users" id="users" class="form-control field-required field-digits" type="number"  style=" border-radius: 0px 10px 0px 10px; width: 70px">
    &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;Text here trial<b style="color: red;">*</b>:&nbsp; &nbsp;&nbsp;<input type="radio" name="trial" value="yes">Yes &nbsp; &nbsp;<input type="radio" name="trial" value="no">No
    </div><!-- end of box -->   
	
	<div id="box" align="center"><input type="Submit" name="Submit" value="Submit" style="border-radius:5px; margin: 5px; font-size: small; padding: 5px" onClick="return confirm('Congrats, We have successfully registered your organization!!!')"/> &nbsp;&nbsp;  &nbsp;&nbsp; <a class="btn" href="<%=paymentURL%>">Next</a></div><!-- end of box -->
</form>
</div><!-- end of main -->  
