...
<img id="output" style="width: 100px; height: 120px; margin-left: 450px; border-style: solid; border-width: medium;"/>
<input type="file" accept="image/*" onchange="loadFile(event)" style="margin-left: 380px; font-size: small;" >
<script>
...
output.src = URL.createObjectURL(event.target.files[0]);
	...
	<div class="box" style="margin-left: 108px">Full Name<b style="color: red;">*</b>: &nbsp; &nbsp;
    ...
    <br>
    <div class="box" style="margin-left: 108px">Gender: &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;<input type="radio" name="sex" value="male">Male
&nbsp; &nbsp;<input type="radio" name="sex" value="female">Female
    </div><!-- end of box -->
	<br>
	
    
     <div class="box" style="margin-left: 108px; margin-bottom: 20px"> Address<b style="color: red;">*</b>:&nbsp; &nbsp; &nbsp;&nbsp;  
        <textarea class="form-control field-required" style="width: 350px; height: 60px; border-radius: 0px 10px 0px 10px"></textarea>
    </div><!-- end of box -->
    ...
    <div id="box" align="center"><a href="<%=Change_passURL%>">Change Password</a></div><!-- end of box --><br>
    <div id="box" align="center"><input class="btn btn-success" type="submit" value="Submit">&nbsp; &nbsp; &nbsp;&nbsp;<input class="btn btn-success" type="submit" value="Next"></div><!-- end of box -->
</form>
</div><!-- end of main --> 
